...
export type ArrayOf_PendingRewardsDetailRes = PendingRewardsDetailRes[];

export interface PendingRewardsDetailRes {
  reward_asset: AssetBaseFor_Addr;
  share: Uint128;
  staked_asset: AssetBaseFor_Addr;
}
/**
