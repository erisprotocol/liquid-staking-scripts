...
export type ArrayOf_AssetInfoWithRuntime = AssetInfoWithRuntime[];

export interface AssetInfoWithRuntime {
  config: AssetConfigRuntime;
  info: AssetInfoBaseFor_Addr;
  whitelisted: boolean;
}
export interface AssetConfigRuntime {
  harvested: Uint128;
  last_taken_s: number;
  stake_config: StakeConfigFor_Addr;
  taken: Uint128;
  yearly_take_rate: Decimal;
}
