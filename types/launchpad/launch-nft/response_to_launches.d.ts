...
export type ArrayOf_Launch = Launch[];
...
export interface NftFor_Addr {
  contract: Addr;
  token_id: string;
}
export interface NftRuntime {}
export interface NftSetup {
  to_amount: Uint128;
}
export interface LaRuntime {
  end: End;
  remaining: Uint128;
