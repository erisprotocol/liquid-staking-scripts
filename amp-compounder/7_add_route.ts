...
(async function () {
  ...
  const routes = [
    // [tokens.red, tokens.luna, tokens.red],
    [tokens.sayve, tokens.luna, tokens.red],
    // [tokens.tpt, tokens.luna, tokens.red],
    // [tokens.ampluna, tokens.luna, tokens.red],

    [tokens.astro, tokens.usdc, tokens.luna, tokens.red],
    [tokens.vkr, tokens.usdc, tokens.luna, tokens.red],

    [tokens.xastro, tokens.astro, tokens.usdc, tokens.luna, tokens.red],
  ];
