...
import { addInfo, Chains, createLCDClient, createWallet, getPrefix, instantiateWithConfirm } from "../helpers";
...
(async function () {
  ...
  addInfo("launchpad", network, LaunchpadInfoKeys.global_config_addr, result.address);
})();
